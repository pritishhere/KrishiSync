...
export const getSmartAdvisory = async (req, res) => {
    try {
        ...
        // Agar farmer ke paas sensor nahi hai, toh default 45% maan lenge for logic testing
        const soilMoisture = providedSoilMoisture || 45; 
        const apiKey = process.env.WEATHER_API_KEY;

        // Hum current nahi, "Forecast" API call kar rahe hain taaki Rain Probability mil sake
        ...
        // Real Data Extraction (Agli 3 ghante ki forecast)
        ...
        // Rule 5: Danger detect hone par (inside advisoryController.js)
if (warnings.length > 0) {
    console.log(`\n🚨 [SMS TRIGGERED TO ${req.user?.phone || 'FARMER'}]`);
    console.log(`💬 Message: "Kisan bhai, khet mein khatra hai. Kripya app check karein."\n`);
}
